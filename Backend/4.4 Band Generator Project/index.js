...
app.post("/submit", (req, res) => {
  ...
  var randomName1 = adj[Math.floor(Math.random() * adj.length)];
  var randomName2 = noun[Math.floor(Math.random() * noun.length)];
  var bandName = `${randomName1} ${randomName2}`;
  res.render("index.ejs", { band: bandName, year: year });
});
